...
public class servletAlterarProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String vtitulo= request.getParameter("vtitulo") ;
            String vdescricao= request.getParameter("vdescricao");
            Double vpreco = Double.valueOf(request.getParameter("vpreco"));
            String vimg = request.getParameter("vimg");
            int vcodigo = Integer.valueOf(request.getParameter("vcodigo"));
